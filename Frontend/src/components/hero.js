...
// import DangerousHTML from "./DangerousHTMLFallback"; // adjust path if needed
...
const Hero = (props) => {
  ...
  // Inject the CSS that was previously inside <Script>
  useEffect(() => {
    const style = document.createElement('style');
    style.setAttribute('data-from', 'Hero-inline-style');
    style.textContent = `
      @keyframes scroll-x {
      ...
      <div className="hero-content2">
        ...
        <div className="hero-row-container2 thq-mask-image-horizontal thq-animated-group-container-horizontal">
          ...
          <div className="thq-animated-group-horizontal-reverse">
            ...
            <img alt="Hero Image" src="https://images.unsplash.com/photo-1568214379698-8aeb8c6c6ac8?ixid=M3w5MTMyMXwwfDF8c2VhcmNofDEyfHxncmFmaWN8ZW58MHx8fHwxNzE1Nzk0OTk5fDA&amp;ixlib=rb-4.0.3&amp;w=1500" className="hero-placeholder-image33 thq-img-ratio-1-1 thq-img-scale" />
          </div>
        </div>
      </div>
